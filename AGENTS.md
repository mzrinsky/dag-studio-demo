...
7.  **Law of Attribution**: Every commit generated by the AI must include a clear attribution at the end of commit message identifying all models used (e.g., `Co-Authored By: Claude 3.5 Sonnet`).
